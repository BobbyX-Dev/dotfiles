...
complete -c mpv -l alang -d 'Specify a priority list of audio languages to use, as IETF language tags'
...
complete -c mpv -l deinterlace-field-parity -d 'Specify the field parity/order when deinterlacing(default: auto) Each frame o…'
...
complete -c mpv -l audio-file-auto-exts -d 'Audio file extentions to try and match when using audio-file-auto'
...
complete -c mpv -l osd-bar-border-size -d 'Size of the border of the OSD bar in scaled pixels (see --sub-font-size for d…'
...
complete -c mpv -l osd-border-color -d 'See --sub-color.  Color used for the OSD font border'
...
complete -c mpv -l osd-shadow-color -d 'See --sub-color.  Color used for OSD shadow. sp NOTE: NDENT 7. 0 NDENT 3'
...
complete -c mpv -l cover-art-auto-exts -d 'Cover art extentions to try and match when using cover-art-auto'
complete -c mpv -l cover-art-whitelist -d 'Whether to load files with a filename among "AlbumArt", "Album", "cover", "fr…'
